...
class _StudentLevelCompleteScreenState extends State<StudentLevelCompleteScreen> {
  ...
  void initState() {
    ...
    // Unlock the card safely after the frame builds
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFDF8F5), // Light pinkish background from image
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Floating green dots decorations
                Align(
                ...
                // Tilted Card
                Transform.rotate(
                  angle: -0.05, // Slight tilt to the left
                  child: Container(
                    width: 250,
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
                      color: const Color(0xFFFCEAE5), // Light pinkish card background
                      borderRadius: BorderRadius.circular(32),
                      border: Border.all(color: const Color(0xFF7A8B7A), width: 3), // Grayish green border
                      boxShadow: [
                        BoxShadow(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      // Return to map (StudentMainScreen is just below this screen)
                      Navigator.pop(context);
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF0F641B), // Dark green
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => const StudentJournalScreen()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF2B9BF4), // Light blue
                      padding: const EdgeInsets.symmetric(vertical: 20),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(30),
