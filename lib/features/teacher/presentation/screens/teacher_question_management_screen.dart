...
/// Pantalla para que el profesor cree un nivel personalizado con preguntas,
/// pistas, datos curiosos y un fondo de bioma opcional.
/// Layout responsivo: lista vertical en móvil, dos columnas en desktop.
class TeacherQuestionManagementScreen extends StatefulWidget {
  const TeacherQuestionManagementScreen({super.key});
...
class _TeacherQuestionManagementScreenState
    extends State<TeacherQuestionManagementScreen> {
  final TextEditingController _levelNameController = TextEditingController();
  String? _selectedBackgroundPath;

  // Lista dinámica de preguntas editables
  final List<_QuestionFormData> _questions = [_QuestionFormData()];

  // Assets de fondo predefinidos disponibles
  static const List<Map<String, String>> _backgroundOptions = [
    {'label': 'Ajolote', 'path': 'assets/images/eco_ajolote_mascot.png'},
    {'label': 'Jaguar', 'path': 'assets/images/quiz_jaguar_1778457575331.png'},
    {'label': 'Tortuga', 'path': 'assets/images/quiz_turtle_1778463514370.png'},
    {'label': 'Mariposa', 'path': 'assets/images/quiz_butterfly_1778463527262.png'},
    {'label': 'Tucán', 'path': 'assets/images/quiz_toucan_1778462119800.png'},
    {'label': 'Zorro', 'path': 'assets/images/quiz_fox_1778463541718.png'},
  ];
